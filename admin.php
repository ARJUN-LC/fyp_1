...
function show_combined_data($conn) {
    $sql = "SELECT st_data.roll_num, st_data.name, st_data.dept, marks.sem, marks.sub, marks.assg1, marks.assg2, marks.assg3, marks.cia1, marks.cia2, marks.model FROM st_data LEFT JOIN marks ON st_data.roll_num = marks.st_id";
    $result = $conn->query($sql);
    
    echo "<div class='container'><h2 class='text-center'>Combined Data</h2><table class='table table-striped table-bordered'><thead><tr><th>Roll Number</th><th>Name</th><th>Department</th><th>Semester</th><th>Subject</th><th>Assignment 1</th><th>Assignment 2</th><th>Assignment 3</th><th>CIA 1</th><th>CIA 2</th><th>Model</th></tr></thead><tbody>";
